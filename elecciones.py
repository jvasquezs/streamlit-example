...
try:
  mesas=pd.read_csv("https://github.com/jvasquezs/streamlit-example/master/mesas.csv",index=0)
except:
...
if st.button('Guardar'):
  ...
  mesas.to_csv("https://github.com/jvasquezs/streamlit-example/master/mesas.csv")
